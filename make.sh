...
defconfig_path="vendor/flash_lao_com-perf_defconfig"
kbuild_build_user="Flashlmdd"
...
if [ ${buildtype} == gcc ];then
    export PATH=$PATH:${HOME}/cbl/aarch64-linux-gnu-
...
zipfile(){
    {zipfiles}="(${build_device})-${kernel_name}-$date.zip"
